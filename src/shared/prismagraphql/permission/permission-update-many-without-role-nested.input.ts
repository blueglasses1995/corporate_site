...
export class PermissionUpdateManyWithoutRoleNestedInput {
  ...
  @Field(() => [PermissionUpsertWithWhereUniqueWithoutRoleInput], {
    nullable: true,
  })
  ...
  set?: Array<Prisma.AtLeast<PermissionWhereUniqueInput, 'id'>>;

  @Field(() => [PermissionWhereUniqueInput], { nullable: true })
  @Type(() => PermissionWhereUniqueInput)
  disconnect?: Array<Prisma.AtLeast<PermissionWhereUniqueInput, 'id'>>;

  @Field(() => [PermissionWhereUniqueInput], { nullable: true })
  @Type(() => PermissionWhereUniqueInput)
  delete?: Array<Prisma.AtLeast<PermissionWhereUniqueInput, 'id'>>;

  @Field(() => [PermissionWhereUniqueInput], { nullable: true })
  @Type(() => PermissionWhereUniqueInput)
  connect?: Array<Prisma.AtLeast<PermissionWhereUniqueInput, 'id'>>;

  @Field(() => [PermissionUpdateWithWhereUniqueWithoutRoleInput], {
    nullable: true,
  })
  @Type(() => PermissionUpdateWithWhereUniqueWithoutRoleInput)
  update?: Array<PermissionUpdateWithWhereUniqueWithoutRoleInput>;

  @Field(() => [PermissionUpdateManyWithWhereWithoutRoleInput], {
    nullable: true,
  })
