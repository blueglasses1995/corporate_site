...
export class ArticleUncheckedUpdateManyWithoutCategoryNestedInput {
  ...
  @Field(() => [ArticleUpsertWithWhereUniqueWithoutCategoryInput], {
    nullable: true,
  })
